...
?><?$APPLICATION->IncludeComponent(
	...
	false
);?><?$APPLICATION->IncludeComponent("bitrix:form", "hk-form1", Array(
	"AJAX_MODE" => "Y",	// Включить режим AJAX
		...
		"SUCCESS_URL" => "/resort/articles/success.php",	// Страница с сообщением об успешной отправке
		"USE_EXTENDED_ERRORS" => "N",	// Использовать расширенный вывод сообщений об ошибках
		"WEB_FORM_ID" => "1",	// ID веб-формы
		"COMPONENT_TEMPLATE" => "hk-form",
		"SEF_URL_TEMPLATES" => array(
			"new" => "#WEB_FORM_ID#/",
			"list" => "",
			"edit" => "",
